...
CREATE TABLE "expenses" (
	...
	"source" varchar(20) DEFAULT 'text' NOT NULL,
	...
	CONSTRAINT "expenses_source_check" CHECK ("expenses"."source" IN ('text', 'voice', 'bank_push'))
);
--> statement-breakpoint
...
CREATE TABLE "notable_dates" (
	"id" serial PRIMARY KEY NOT NULL,
	"tribe_id" integer DEFAULT 1 NOT NULL,
...
CREATE TABLE "nutrition_analyses" (
	...
	"model_used" varchar(100),
	"status" varchar(20) DEFAULT 'pending' NOT NULL,
	"source" varchar(20) DEFAULT 'photo' NOT NULL,
	"error_message" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "support_reports" (
	...
	"category" varchar(50) DEFAULT 'home_screen' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "tribe_monthly_limits" (
	"id" serial PRIMARY KEY NOT NULL,
	"tribe_id" integer NOT NULL,
	...
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tribe_monthly_limits_month_range" CHECK ("tribe_monthly_limits"."month" BETWEEN 1 AND 12),
	CONSTRAINT "tribe_monthly_limits_amount_positive" CHECK ("tribe_monthly_limits"."limit_amount" > 0)
);
--> statement-breakpoint
CREATE TABLE "tribes" (
	"id" serial PRIMARY KEY NOT NULL,
...
CREATE TABLE "users" (
	...
	"chat_provider" varchar(20) DEFAULT 'free' NOT NULL,
...
ALTER TABLE "nutrition_analyses" ADD CONSTRAINT "nutrition_analyses_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "nutrition_products" ADD CONSTRAINT "nutrition_products_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reminders" ADD CONSTRAINT "reminders_sound_id_reminder_sounds_id_fk" FOREIGN KEY ("sound_id") REFERENCES "public"."reminder_sounds"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "support_reports" ADD CONSTRAINT "support_reports_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "support_reports" ADD CONSTRAINT "support_reports_resolved_by_users_id_fk" FOREIGN KEY ("resolved_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tribe_monthly_limits" ADD CONSTRAINT "tribe_monthly_limits_tribe_id_tribes_id_fk" FOREIGN KEY ("tribe_id") REFERENCES "public"."tribes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_active_dialog_id_chat_dialogs_id_fk" FOREIGN KEY ("active_dialog_id") REFERENCES "public"."chat_dialogs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_expenses_dedup_hash" ON "expenses" USING btree ("dedup_hash") WHERE "expenses"."dedup_hash" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "idx_gandalf_categories_tribe" ON "gandalf_categories" USING btree ("tribe_id");--> statement-breakpoint
CREATE UNIQUE INDEX "gandalf_categories_user_name_key" ON "gandalf_categories" USING btree ("created_by_user_id","name") WHERE "gandalf_categories"."tribe_id" IS NULL AND "gandalf_categories"."is_active" = true;--> statement-breakpoint
...
CREATE INDEX "idx_gandalf_entries_added_user" ON "gandalf_entries" USING btree ("added_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_nutrition_analyses_user_created" ON "nutrition_analyses" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_nutrition_analyses_status" ON "nutrition_analyses" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_nutrition_products_user" ON "nutrition_products" USING btree ("user_id","name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_reminder_sounds_name" ON "reminder_sounds" USING btree ("name");--> statement-breakpoint
...
CREATE INDEX "idx_support_reports_status" ON "support_reports" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_support_reports_user" ON "support_reports" USING btree ("user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "task_works_user_name_active_key" ON "task_works" USING btree ("user_id",lower("name")) WHERE is_archived = false;--> statement-breakpoint
...
CREATE INDEX "idx_ts_delivery" ON "thought_simplifications" USING btree ("user_id","sequence_number") WHERE is_delivered = false;--> statement-breakpoint
CREATE UNIQUE INDEX "idx_tribe_monthly_limits_unique" ON "tribe_monthly_limits" USING btree ("tribe_id","year","month");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_users_telegram_id" ON "users" USING btree ("telegram_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_users_webhook_secret" ON "users" USING btree ("webhook_secret");--> statement-breakpoint
