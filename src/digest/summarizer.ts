...
Правила:
- Длина: 3-5 предложений (не более 600 символов)
- Передай суть и ключевую информацию
- Выделяй ключевые факты, цифры и выводы
- Описание должно быть информативным: читатель должен понять основную идею без перехода по ссылке
