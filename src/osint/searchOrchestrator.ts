...
Правила:
- followUpQueries: 10-15 запросов, НЕ повторяющих запросы Фазы 1
- profileUrls: до 20 URL, приоритет — соцсети, rusprofile, реестры, LinkedIn
- discoveredEntities: связанные лица, компании, ИНН обнаруженные в результатах
- keyFindings: 3-5 предложений с главными находками`;
...
*Идентификация* — ФИО (полное), дата рождения, предполагаемый возраст, город проживания, ИНН/ОГРН если найдены.

*Хронология ключевых событий* — хронологический список (по годам) основных событий: регистрация компаний, судебные дела, смена должностей, публикации. Формат: "ГГГГ — событие (источник)".

*Биография и образование* — учебные заведения (школа, университет, степени), специальность, карьерный путь по годам. Курсы, сертификаты, научные работы/диссертации. Источники данных.

*Профессиональная деятельность* — должности, компании, роли (учредитель, директор, сотрудник). Карьерный путь если прослеживается. Профессиональные достижения.

*Финансовые данные и бизнес* — выручка и прибыль компаний (rusprofile.ru), доли владения, уставный капитал. Исполнительные производства ФССП (суммы, статус). Арбитражные дела (arbitr.ru): суммы, роль (истец/ответчик). Банкротство. Долговые обязательства.

*Государственные реестры* — данные из ЕГРЮЛ/ЕГРИП (компании, ИП, даты регистрации, статус), ФССП (исполнительные производства с суммами), судебные решения (sudact.ru), банкротство (fedresurs). Если ничего не найдено — укажи это явно.

*Недвижимость и адреса* — адреса регистрации компаний, адреса из публичных источников, данные Росреестра (собственность), адреса из reformagkh.ru. Только публично доступные данные.

*Онлайн-присутствие и фотографии* — профили в соцсетях (VK, OK, Instagram, Facebook, LinkedIn, Pikabu, Drive2) со ссылками. Форумы, блоги, комментарии. ВСЕ найденные URL фотографий — перечисли каждый с описанием и источником, пометка 📷.

*Контактная информация* — телефоны, email, мессенджеры (Telegram, WhatsApp), сайты. Только публично доступные данные.

*Упоминания в СМИ* — статьи, новости, обсуждения, публикации. Укажи источник, дату и краткое содержание каждого упоминания.
...
*Семья и окружение* — члены семьи из публичных источников (соцсети, реестры), деловые партнёры, связанные лица, совместные компании/проекты.

*Перекрёстный анализ* — факты, подтверждённые несколькими независимыми источниками. Противоречия между источниками. Паттерны поведения и связей.

*Оценка достоверности* — уровень уверенности в собранных данных (высокий/средний/низкий), найденные противоречия, пробелы в информации, рекомендации по дополнительной проверке. Какие направления требуют углублённого поиска.
