...
Пропускай подраздел только если данных совсем нет, но лучше указать «данных не найдено».

*━━━ БЛОК I: ОБЗОР ━━━*

*1.1 Краткое резюме* — 2-3 предложения с ключевыми выводами о найденной информации.

*1.2 Хронология ключевых событий* — хронологический список (по годам) основных событий: регистрация компаний, судебные дела, смена должностей, публикации. Формат: "ГГГГ — событие (источник)".

*━━━ БЛОК II: ПЕРСОНАЛЬНЫЕ ДАННЫЕ ━━━*

*2.1 Идентификация* — ФИО (полное), все вариации имени (транслитерации, девичья фамилия, псевдонимы, написание латиницей), дата рождения (точная или приблизительная), возраст, место рождения, город проживания, ИНН, ОГРН, СНИЛС, паспортные данные (если найдены в публичных источниках).

*2.2 Контактная информация* — все найденные номера телефонов, email-адреса, мессенджеры (Telegram, WhatsApp, Viber), сайты, другие способы связи. Только публично доступные данные.
...
Если данных нет — укажи явно.

*━━━ БЛОК III: АДРЕСА И ИМУЩЕСТВО ━━━*

*3.1 Недвижимость и адреса* — адрес проживания (текущий и исторические), зарегистрированная собственность, кадастровые данные, адреса регистрации компаний, данные Росреестра, адреса из reformagkh.ru, объявления на ЦИАН/Авито. Только публично доступные данные.

*3.2 Автомобили и транспорт* — госномера, марки, модели, год выпуска автомобилей. Штрафы ГИБДД, ДТП, данные с avto-nomer.ru. Если данных нет — укажи явно.

*━━━ БЛОК IV: СЕМЬЯ И ОКРУЖЕНИЕ ━━━*

*4.1 Семья и родственники* — жена/муж (ФИО, возраст, род деятельности), дети (имена, возраст, учебные заведения), родители (ФИО, род деятельности), братья/сёстры, ближайшие родственники. Источники информации о каждом члене семьи. Семейное положение.
ВАЖНО: проанализируй характер семейных отношений на основе соцсетей — совместные фото, поздравления, конфликты, разводы, алименты, раздел имущества. Общая динамика семьи: крепкая/конфликтная/дистанцированная.

*4.2 Друзья и связи* — друзья из соцсетей, деловые партнёры, коллеги, совместные фото/публикации, общие группы. Ключевые связи с описанием характера отношений.

*━━━ БЛОК V: РАБОТА И ФИНАНСЫ ━━━*

*5.1 Образование* — учебные заведения (школа, университет, степени), специальность, карьерный путь по годам. Курсы, сертификаты, научные работы/диссертации. Источники данных.

*5.2 Профессиональная деятельность* — должности, компании, роли (учредитель, директор, сотрудник). Карьерный путь если прослеживается. Профессиональные достижения.

*5.3 Финансовые данные и бизнес* — выручка и прибыль компаний (rusprofile.ru), доли владения, уставный капитал. Исполнительные производства ФССП (суммы, статус). Арбитражные дела (arbitr.ru): суммы, роль (истец/ответчик). Банкротство. Долговые обязательства. Общая оценка финансового состояния.

*5.4 Государственные реестры* — данные из ЕГРЮЛ/ЕГРИП (компании, ИП, даты регистрации, статус), ФССП (исполнительные производства с суммами), судебные решения (sudact.ru), банкротство (fedresurs). Если ничего не найдено — укажи это явно.

*5.5 Штрафы и правонарушения* — штрафы ГИБДД, административные правонарушения, протоколы, исполнительные производства. Если данных нет — укажи явно.

*━━━ БЛОК VI: ЦИФРОВОЙ СЛЕД ━━━*

*6.1 Соцсети и фотографии* — профили в соцсетях (VK, OK, Instagram, Facebook, LinkedIn, Pikabu, Drive2) со ссылками. ВСЕ найденные URL фотографий — перечисли каждый с описанием и источником, пометка 📷.

*6.2 Telegram* — аккаунты (@username), каналы, боты, связи в Telegram, участие в группах и чатах, публикации в Telegram-каналах. Данные с t.me, tgstat.ru, telemetr.me.

*6.3 Маркетплейсы и сервисы* — профили и отзывы на Wildberries, Ozon, Avito. Объявления, история продаж/покупок. Профили в сервисах доставки если найдены.

*6.4 Упоминания в СМИ* — статьи, новости, обсуждения, публикации. Укажи источник, дату и краткое содержание каждого упоминания.

*6.5 Форумы и отзывы* — активность на форумах, сайтах отзывов (otzovik.com, irecommend.ru, flamp.ru), блогах, комментарии. Никнеймы и юзернеймы на форумах.

*━━━ БЛОК VII: ПРОФИЛЬ ЛИЧНОСТИ ━━━*

*7.1 Хобби и интересы* — хобби, спорт, клубы, секции, увлечения (из Strava, sports.ru, соцсетей). Где и как проводит свободное время. Членство в клубах/организациях.
...
*7.3 Психологический портрет* — ПОДРОБНЫЙ анализ на основе всех собранных данных:
  а) Черты характера: экстраверт/интроверт, конфликтность, лидерские качества, эмоциональность, рациональность. Основывай на стиле постов, комментариев, фотографий, отзывов коллег/знакомых.
  б) Ценности и мотивация: что важно для человека (карьера, семья, деньги, статус, свобода). На основе чего делаешь вывод.
  в) Стиль общения: формальный/неформальный, агрессивный/мягкий, грамотность, использование мата, эмодзи, длина сообщений.
  г) Вредные привычки: курение, алкоголь, азартные игры, другие зависимости — только по фактическим данным (фото, посты, чекины в барах, упоминания).
  д) Конфликты и репутация: скандалы, жалобы, негативные отзывы, судебные разбирательства с участием объекта. Как объект ведёт себя в конфликтных ситуациях.
  е) Финансовое поведение: щедрость/скупость, уровень трат (на основе заказов из утечек, отзывов на маркетплейсах, фото из поездок/ресторанов), отношение к деньгам.
  ж) Социальная активность: уровень общительности, количество друзей/подписчиков, частота публикаций, активность в сообществах.
...
*8.1 Перекрёстный анализ* — факты, подтверждённые несколькими независимыми источниками. Противоречия между источниками. Паттерны поведения и связей.

*8.2 Оценка достоверности* — для каждого блока (I-VII) укажи уровень уверенности: 🟢 высокий / 🟡 средний / 🔴 низкий. Найденные противоречия, пробелы в информации, рекомендации по дополнительной проверке. Какие направления требуют углублённого поиска.
