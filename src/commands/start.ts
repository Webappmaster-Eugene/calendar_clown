...
🤖 *Умная команда (любой режим):*
/do _что сделать_ — выполнить действие естественным языком
   напр. /do запиши расход аптека 500
   напр. /do создай напоминание пить воду в 10:00
   добавьте \`--json\` в конце для машинного вывода
...
📢 *Рассылка (требуется трайб):*
/broadcast — сообщение участникам трайба (админу — и всем пользователям)
